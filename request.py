...
class information_of_books:
    ...
    #     description_list = []
    #     for describe in self.Book:
    #         # try:
    #         #     tags = describe.select("div#bookDescription_feature_div > div > div > span")
    #         # except AttributeError:
    #         tags = describe.select("div#bookDescription_feature_div > div > div > p > span")
    #         description_list.append(['' if detail.findAll("br") else detail.text for detail in tags])
    #     return description_list
        # tags = [describe.select("div#bookDescription_feature_div > div > div > span") for describe in self.Book]
        # description_list = [detail.text for description_tag in tags for detail in description_tag]
        # return description_list
...
ClassInformationOfBook = information_of_books()

# Call 2nd Class
# SubClassInformationOfBook = ClassInformationOfBook.book_stars(ClassInformationOfBook)

# Call Function in ClassInformationOfBook
# BookName = ClassInformationOfBook.book_name()
# WriterName = ClassInformationOfBook.writer_name()
# SellerName = ClassInformationOfBook.seller_name()
KindleAvaliable = ClassInformationOfBook.avaliable_kindle()
# KindlePrice, AudiobookPrice, HardcoverPrice, PaperbackPrice = ClassInformationOfBook.book_price()
# BookDescription = ClassInformationOfBook.description()

# Call Function in SubClassInformationOfBook
# AverageStars = SubClassInformationOfBook.average_star()
# FiveStar, FourStar, ThreeStar, TwoStar, OneStar = SubClassInformationOfBook.percentages_each_type_of_stars()
# NumberOfCustomersReview = SubClassInformationOfBook.number_of_customers_review()
